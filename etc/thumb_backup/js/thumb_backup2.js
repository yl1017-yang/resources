...
document.querySelector(".bi-pulmuone").addEventListener('click', function () {
  ...
  for (let i = 0; i < ele.length; i++) {
    ...
    ele[i].classList.remove("bi-orga", "bi-foodmerce", "bi-water", "bi-danone");
    console.log(ele[i]);
  }
});
document.querySelector(".bi-orga").addEventListener('click', function () {
  ...
  for (let i = 0; i < ele.length; i++) {
    ...
    ele[i].classList.remove("bi-pulmuone", "bi-foodmerce", "bi-water", "bi-danone");
    console.log(ele[i]);
  }
});
document.querySelector(".bi-foodmerce").addEventListener('click', function () {
  ...
  for (let i = 0; i < ele.length; i++) {
    ...
    ele[i].classList.remove("bi-pulmuone", "bi-orga", "bi-water", "bi-danone");
    console.log(ele[i]);
  }
});
document.querySelector(".bi-water").addEventListener('click', function () {
  ...
  for (let i = 0; i < ele.length; i++) {
    ...
    ele[i].classList.remove("bi-pulmuone", "bi-orga", "bi-foodmerce", "bi-danone");
    console.log(ele[i]);
  }
});
document.querySelector(".bi-danone").addEventListener('click', function () {
  ...
  for (let i = 0; i < ele.length; i++) {
    ...
    ele[i].classList.remove("bi-pulmuone", "bi-orga", "bi-water", "bi-foodmerce");
    console.log(ele[i]);
  }
});
...
function msgName() {
  ...
  document.querySelector(".name-show").innerText = name;
  return name;
}
  ...
  setTimeout(function () {
    html2canvas(document.querySelector("#capture" + arr[download_index]), {
      ...
      .then(canvas => {
        ...
        wantedWidth = 550;
        wantedHeight = 550;
        saveImg(canvas.toDataURL("image/jpg"), wantedWidth, wantedHeight, (wantedWidth + "X" + wantedHeight + "_" + arr[download_index] + "_" + msg + ".jpg"));

        // 2 번째 1200
        wantedWidth = 1200;
        wantedHeight = 1200;
        saveImg(canvas.toDataURL("image/jpeg", 0.4), wantedWidth, wantedHeight, (wantedWidth + "X" + wantedHeight + "_" + arr[download_index] + "_" + msg + ".jpg"));
...
function rowShot() {
  ...
  for (let i = 0; i < arr.length; i++) {
    html2canvas(document.querySelector("#rowcapture" + arr[i]), {
      ...
      .then(canvas => {
        rowsaveImg(canvas.toDataURL('image/jpg'), ("640X320_" + arr[i] + "_" + msg + ".jpg"));
      });
  }
}
