Vue.component('saleItem', {
    ...
    , template : `
    <div id="tab03" class="tab03" style="height:1000px;background:#FF4895">
    ...
    methods : {
         ...
         */
         prdDetailPage(itemid){
            if(isApp) {
                ...
                fnAmplitudeEventAction('click_tentensale_sale_product', 'item_id', itemid, callback);
            } else {
        ...
        exhibitionDetailPage(masterCode,catecode,categoryname){
            if(isApp) {
                fnAPPpopupBrowserURL('3월 텐텐세일', 'http://m.10x10.co.kr/apps/appCom/wish/web2014/tentensale/2023/exhibitionDetailView.asp?masterCode=' + masterCode + '&catecode=' + catecode,'right','','sc');
                fnAmplitudeEventAction('click_tentensale_sale_product', 'category_name', categoryname, callback);
            } else {
        ...
        exhibitionDetailPage2(masterCode,catecode,categoryname){
            if(isApp) {
                fnAPPpopupBrowserURL('3월 텐텐세일', 'http://m.10x10.co.kr/apps/appCom/wish/web2014/tentensale/2023/exhibitionDetailView.asp?masterCode=' + masterCode + '&catecode=' + catecode,'right','','sc');
                fnAmplitudeEventAction('click_tentensale_sale_product_button', 'category_name', categoryname, callback);
            } else {
                location.href = '/tentensale/2023/detail/index.asp?masterCode=' + masterCode + '&catecode=' + catecode;
        ...
        goMdEvent01() {
            if (isapp) {
                fnAPPpopupBrowserURL('기획전', "https://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=122054", 'right', '', 'sc');
                fnAmplitudeEventAction('click_tentensale_MDbanner_brand', '', '', callback);
            } else {
        ...
        goMdEvent02() {
            if (isapp) {
                fnAPPpopupBrowserURL('기획전', "https://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=121738", 'right', '', 'sc');
                fnAmplitudeEventAction('click_tentensale_MDbanner_item', '', '', callback);
            } else {
