...
function fnApplyItemInfoEach(opts) {
	...
	var additionalHtml = function(saleString , couponString , saleBracket) {
		...
		var saleStringHtml = saleString !="" ? saleBracket !="" ? "<span class=\'sale\'>["+ saleString +"]</span>" : "<span class=\'sale\'>"+saleString+"</span>": "";
		var couponStringHtml = couponString !="" ? saleBracket !="" ? "<span class=\'sale\'>["+ couponString +"]</span>" : "<span class=\'sale\'>"+couponString+"</span>": "";
		var returnHtml = saleStringHtml.concat(couponStringHtml);
			...
			if(typeof(message)=="object") {
				if(typeof(message.items)=="object") {
					...
					$(message.items).each(function(){
						// 상품 이미지 출력
						if(isImg){
							$("."+opts.target+this.itemid+" .thumbnail img").attr("src",this.imgurl + "/10x10/optimize");
						}
						...
						if(isPrc){
							if(isSale){
								...
								if(this.saleper!="") {
									var saleCouponTag="";
									if(this.saleTag == "sale" || this.saleTag == "coupon"){
										saleCouponTag="class='sale'";
									}
									if (this.itemdiv == "21") {
										if (opts.saleBracket) {
